            ...
            <div class="col-md-8">
                <div class="col-md-2">
                    ...
                    <img src="${pageContext.request.contextPath}/${picture.fileName}"
                     class="img-thumbnail" alt="${picture.title}" width="300" height="300">
                    ...
                    <p>${hero.superPower}</p>                   
                        ...
                        <p>
                            <a href="${pageContext.request.contextPath}/sightingsController/displaySightingDetails?heroId=${hero.id}"><h4>Sightings</h4></a>
                        </p>
                    </c:if>
                </div>
