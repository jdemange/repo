        ...
        <div class="">
            <div class="col-md-8">
                ...
                <div class="box col-md-10">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" action="${pageContext.request.contextPath}/heroController/editHero"
                          method="POST">
                        <div class="form-group">
                            <label for="add-name" class="col-md-4 control-label">Superhero Name:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="name" value="${hero.name}" id="add-description" placeholder="name"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-description" class="col-md-4 control-label">Description:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" value="${hero.description}" name="description" id="add-description"
                                       placeholder="description"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="add-ppwer" class="col-md-4 control-label">Super Power:</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" value="${hero.superPower}" name="superPower" id="add-power"
                                       placeholder="power"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="submit" class="btn btn-default" value="Update Hero Details"/>
                    </form>
